...
def Image_Rectification(camera_config, img_left, img_right, imgsz=640, path=False, debug=False):
    # 读取MiddleBurry数据集的图片
    t0 = time.time()
    if path:
    ...
    # 图像缩放
    # _, iml_rectified, imr_rectified = resize_convert(iml_rectified, imr_rectified, imgsz, stride)
