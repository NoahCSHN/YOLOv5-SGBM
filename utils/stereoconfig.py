...
class stereoCamera(object):
    ...
    def __init__(self,mode=1,height=1280,width=960):
        if mode==0:
            ...
            # 焦距 unit:pixel resolution ratio ，1280*960 1061.25 640*640 530.625 416*416 344.906
            self.focal_length = 344.906 

            # 焦距 unit:pixel 1061.25
            self.focal_length_pix = 1061.25  # 默认值，一般取立体校正后的重投影矩阵Q中的 Q[2,3]
